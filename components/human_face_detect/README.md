...
| name                           | input(h*w*c)  | preprocess(ms) | model(ms) | postprocess(ms) | mAP50-95 on custom val set  |
| -------------------------------- | --------------- | ---------------- | ----------- | ----------------- | ----------------------------- |
|  msr_s8_v1_s3 |  120 * 160 * 3 | 3.8 | 33.1 | 0.3 |  / |
|  msr_s8_v1_p4 |  120 * 160 * 3 | 1.3 | 13.1 | 0.1 |  / |
|  mnp_s8_v1_s3 |  48 * 48 * 3 | 0.6 | 5.8 | 0.1 |  0.367(msr + mnp) |
|  mnp_s8_v1_p4 |  48 * 48 * 3 | 0.3 | 2.4 | 0.0 |  0.366(msr + mnp) |
|  espdet_pico_224_224_face_s8_s3 |  224 * 224 * 3 | 7.2 | 131.6 | 0.8 |  0.504 |
|  espdet_pico_416_416_face_s8_s3 |  416 * 416 * 3 | 21.8 | 437.0 | 1.3 |  0.598 |
|  espdet_pico_224_224_face_s8_p4 |  224 * 224 * 3 | 2.4 | 49.6 | 0.4 |  0.504 |
|  espdet_pico_416_416_face_s8_p4 |  416 * 416 * 3 | 6.6 | 185.9 | 0.6 |  0.597 |
